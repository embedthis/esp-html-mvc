/*
   Generated from app/post/post-edit.esp
 */
#include "esp.h"

static void view_74a0874f16134bf05b6b03bac48d550b(HttpConn *conn) {
EdiRec      *rec = getRec();
    EdiField    *fp;
...
ESP_EXPORT int esp_view_74a0874f16134bf05b6b03bac48d550b(HttpRoute *route, MprModule *module) {
   espDefineView(route, "app/post/post-edit.esp", view_74a0874f16134bf05b6b03bac48d550b);
   return 0;
}
